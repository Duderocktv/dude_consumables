...
function InitializeInventory()
    DebugPrint("^2[dude_consumables] Initializing ox_inventory integration...^0")
    
    lib.callback.register("dude_consumables:getInventory", function(source)
    ...
    DebugPrint("^2[dude_consumables] ox_inventory integration complete!^0")
